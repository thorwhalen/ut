...
#
# until_slash_re = re.compile(until_slash)
# until_slash_capture_re = re.compile(until_slash_capture)
names_re = re.compile('(?<={)[^}]+(?=})')
...
class LinearNaming(object):
    ...
    def info_dict(self, sref):
        ...
        {'subuser': 'SUBUSER', 'group': 'GROUP', 'e_ums': 1485261448469, 'user': 'USER', 'day': '2017-01-24', 's_ums': 1485272231982}
        >>> uploads_sref = "s3://uploads/GROUP/upload/files/USER/2017-01-24/SUBUSER/a_file.wav"
        ...
        {'subuser': 'SUBUSER', 'group': 'GROUP', 'user': 'USER', 'day': '2017-01-24', 'filename': 'a_file.wav'}
        """
