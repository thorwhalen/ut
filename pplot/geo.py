...
def map_records(
    d, basemap_kwargs={}, plot_kwargs={}, lat_col='latitude', lng_col='longitude'
):
    # Create the Basemap
    basemap_kwargs = dict(
        dict(
            projection='merc',  # there are other choices though
    ...
    plot_kwargs = dict(
        dict(marker='o', markersize=7, color='b', alpha=0.1), **plot_kwargs
    )
