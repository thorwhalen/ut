...
def find_new_docs(collection=None, date_key=None, thresh_date=None, output='cursor'):
    ...
    if isinstance(
        thresh_date, int
    ):  # if thresh_date is an int, consider it to be the number of days than defines "new"
...
def find_old_docs(collection=None, date_key=None, thresh_date=None, output='cursor'):
    ...
    if isinstance(
        thresh_date, int
    ):  # if thresh_date is an int, consider it to be the number of days than defines "old"
